package com.wgh.springcloud.cloudproviderhystrixpayment8001.service;
...
//    })
    public String paymentInfo_TimeOut(Integer id) {
        ...
        return "线程池：" + Thread.currentThread().getName() + "paymentInfo_IimeOut,id：" + id + "\t" + "O(∩_∩)O哈哈~" + "”耗时(秒)：" + timeNumber;
    }
