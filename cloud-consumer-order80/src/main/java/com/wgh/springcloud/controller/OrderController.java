...
import com.wgh.springcloud.lb.LoadBalance;
...
public class OrderController {
    ...
    public CommonResult<Payment> getPaument(@PathVariable("id") Long id) {
        return restTemplate.getForObject(PAYMENT_URL + "/payment/get/" + id, CommonResult.class);
    }

    @GetMapping("/consumer/payment/getForEntity/{id}")
    public CommonResult<Payment> getPaument2(@PathVariable("id") Long id) {
